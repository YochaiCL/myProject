 ...
 */
export default class UpdatePsu extends Component {
  state = {
  ...
  handelClick = index => {
    this.setState({
      ...
      total_output: this.state.products[index].total_output,
    });
  };
   ...
   */ async handleSubmit(e) {
    ...
    let newComponent = {
      ...
      total_output: this.state.total_output,
    };
    const options = {
      method: 'POST',
      crossDomain: true,
    ...
    const response = await fetch(
      'http://localhost:5000/updateComponent/psu',
      options
    );
    const result = await response.json();
                ...
                <section>
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={e =>
                        this.setState({ total_output: e.target.value })
                      }
                    />
