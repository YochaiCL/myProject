...
/**
 * Description - This class display the case products
 */
export default class ProductsCASE extends Component {
  state = {
  ...
  /**
   * Description - This function get the case products
   */
  async getProducts() {
  ...
  render() {
    return (
      <PageLayout>
        <Header h1Heading='Case Products' />
