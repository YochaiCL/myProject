...
/**
 * Description - This class display the ssd m2 products
 */
export default class ProductsSsdM2 extends Component {
  state = {
  ...
  /**
   * Description - This function get the ssd m2 products
   */
  async getProducts() {
  ...
  render() {
    return (
      <PageLayout>
        <Header h1Heading='SSD M2 Products' />
